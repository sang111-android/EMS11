...
<div class="wrap">
  <div class="card">
    <div class="brand">
      <div><div class="brand-name">پنل مدیریت</div><div class="brand-sub">ورود امن مدیر</div></div>
    </div>
    <h1>خوش آمدید</h1>
    <p class="sub">برای دسترسی به داشبورد، رمز عبور مدیریتی خود را وارد کنید.</p>
    ...
    <div class="footer"><i class="ti ti-shield-lock"></i> اتصال رمزنگاری‌شده · ورود فقط برای مدیر</div>
  </div>
</div>
<script>
...
.nav-badge{margin-right:auto;background:rgba(24,155,173,0.15);color:var(--accent2);font-size:9px;padding:1px 6px;border-radius:20px;font-weight:700}
...
<div class="mob-top">
  <div class="ml">
    ...
    <span class="mob-title">پنل مدیریت</span>
  </div>
  <div class="mob-right">
...
<aside class="sidebar" id="sb">
  ...
  <div class="logo">
    ...
    <div><div class="logo-name">پنل مدیریت</div><div class="logo-sub">نسخه ۹.۵</div></div>
  </div>
  <div class="nav-wrap">
...
<section class="pg on" id="pg-overview">
  ...
  <div class="dash-footer">
    <span class="df-text">پنل مدیریت · نسخه ۹.۵</span>
...
<section class="pg" id="pg-support">
  ...
  <div class="srv-panel">
    <div class="srv-hero">
      ...
      <div class="srv-hero-text">
        <div class="srv-hero-domain">مرکز پشتیبانی</div>
        <div class="srv-hero-sub"><span class="dot dg pulse"></span> راه‌های ارتباطی با تیم پشتیبانی</div>
      </div>
    </div>
    <div class="srv-tiles">
      <a class="srv-tile" href="https://www.youtube.com/@X4GHUB" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">یوتیوب</div><div class="srv-tile-val">آموزش‌های تصویری و راهنمای اتصال</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://t.me/x4g_group" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">گروه تلگرام</div><div class="srv-tile-val">پرسش و پاسخ و پشتیبانی کاربران</div></div>
      </a>
      ...
      <a class="srv-tile" href="https://github.com/x4gKing" target="_blank" style="text-decoration:none;cursor:pointer">
        ...
        <div class="srv-tile-text"><div class="srv-tile-label">گیت‌هاب</div><div class="srv-tile-val">مخزن پروژه و مستندات فنی</div></div>
      </a>
    </div>
  </div>
</section>
...
function checkPwStrength(val){
  ...
  const colors=['#B33A22','#C08A2E','#189BAD','#12A08B'],labels=['خیلی ضعیف','ضعیف','متوسط','قوی'];
...
function initCharts(){
  ...
  ch3=new Chart(document.getElementById('ch3'),{
    ...
    data:{labels:[],datasets:[
      {label:'مصرف',data:[],borderColor:'#189BAD',backgroundColor:gradFill3,fill:true,tension:.45,pointRadius:0,pointHoverRadius:7,pointHoverBackgroundColor:'#fff',pointHoverBorderColor:'#189BAD',pointHoverBorderWidth:3,borderWidth:3,order:2},
      {label:'میانگین',data:[],borderColor:'#C08A2E',borderDash:[6,5],borderWidth:1.6,pointRadius:0,fill:false,tension:0,order:1}
    ]},
    options:{
      responsive:true,maintainAspectRatio:false,
      interaction:{mode:'index',intersect:false},
...
let ws;
function wsLog(c,m){const l=document.getElementById('ws-log'),p=document.createElement('p');const colors={ok:'#3EC3AE',err:'#E08167',info:'#BFBFBF',sent:'#E4BE74'};p.style.color=colors[c]||'#fff';p.textContent='['+new Date().toLocaleTimeString('fa-IR')+'] '+m;l.appendChild(p);l.scrollTop=l.scrollHeight}
...
:root{{
  --bg:#0B0F10;--bg2:#0F1415;--bg3:#12191A;
  --card:#111718;--card-b:rgba(63,182,196,0.12);--card-bh:rgba(63,182,196,0.28);
  --accent:#189BAD;--accent2:#4FBECB;--accent-d:rgba(24,155,173,0.1);
  --green:#21B39C;--green-bg:rgba(33,179,156,0.1);--green-t:#4FCFB8;
  --red:#B33A22;--red-bg:rgba(179,58,34,0.1);--red-t:#EE9A83;
  --amber:#CE9A4E;--amber-bg:rgba(206,154,78,0.1);--amber-t:#E6C79A;
  --purple:#C2543A;--purple-bg:rgba(194,84,58,0.1);--purple-t:#E09580;
  --t1:#F2F4F4;--t2:#93A9AC;--t3:#4A5658;
  --radius:18px;--shadow:0 12px 40px rgba(0,0,0,0.45);
  --serif:'Vazirmatn',sans-serif;
}}
[data-theme="light"]{{
  --bg:#F1F2F2;--bg2:#E7E8E8;--bg3:#DCDCDA;
  --card:#FFFFFF;--card-b:rgba(24,155,173,0.14);--card-bh:rgba(24,155,173,0.32);
  --accent:#0F7C8C;--accent2:#0A5561;--accent-d:rgba(15,124,140,0.08);
  --green:#0F8374;--green-bg:rgba(15,131,116,0.08);--green-t:#0A5F55;
  --red:#911F0C;--red-bg:rgba(145,31,12,0.08);--red-t:#7F2010;
  --amber:#A5701F;--amber-bg:rgba(165,112,31,0.08);--amber-t:#7A5215;
  --purple:#7A2211;--purple-bg:rgba(122,34,17,0.08);--purple-t:#5C170A;
  --t1:#1C2325;--t2:#4A5658;--t3:#93A9AC;
  --shadow:0 12px 36px rgba(30,36,37,0.12);
}}
...
.bg-fx{{position:fixed;inset:0;background:radial-gradient(ellipse 70% 45% at 50% -8%,rgba(24,155,173,0.13),transparent 62%),var(--bg);z-index:0;pointer-events:none;transition:background .35s}}
.grid-fx{{position:fixed;inset:0;background-image:linear-gradient(rgba(63,182,196,0.025) 1px,transparent 1px),linear-gradient(90deg,rgba(63,182,196,0.025) 1px,transparent 1px);background-size:46px 46px;z-index:0;pointer-events:none}}
...
.brand-img{{width:40px;height:40px;border-radius:50%;overflow:hidden;border:1px solid var(--card-b);box-shadow:0 0 14px rgba(168,53,28,.3),0 0 8px rgba(24,155,173,.25);flex-shrink:0}}
.brand-img img{{width:100%;height:100%;object-fit:cover}}
...
.sub-info::before{{content:'';position:absolute;top:0;right:0;width:160px;height:160px;background:radial-gradient(circle at top right,rgba(24,155,173,.1),transparent 70%);pointer-events:none}}
...
.copy-all-bar{{display:flex;align-items:center;gap:12px;background:linear-gradient(120deg,var(--accent) 0%,#0D6A78 100%);border-radius:18px;padding:16px 19px;margin-bottom:18px;box-shadow:0 10px 30px rgba(24,155,173,.28);flex-wrap:wrap}}
...
.copy-all-btn{{background:#fff;color:#0A5561;border:none;border-radius:12px;padding:10px 19px;font-family:inherit;font-size:12.5px;font-weight:800;cursor:pointer;display:flex;align-items:center;gap:6px;transition:.18s;white-space:nowrap}}
...
.ubar{{height:6px;border-radius:4px;background:rgba(63,182,196,0.1);overflow:hidden;margin-bottom:5px}}
...
[data-theme="light"] .cfg-vless{{background:rgba(15,124,140,.05)}}
...
.btn i{{font-size:13px}}
.btn-p{{background:linear-gradient(135deg,#12A2B5,#A8351C);color:#fff;box-shadow:0 3px 14px rgba(168,53,28,.35)}}
.btn-p:hover{{background:var(--accent2)}}
.btn-g{{background:var(--accent-d);color:var(--accent2);border:1px solid rgba(63,182,196,.16)}}
.btn-g:hover{{background:rgba(63,182,196,.2)}}
.btn-pur{{background:var(--purple-bg);color:var(--purple-t);border:1px solid rgba(194,84,58,.2)}}
.btn-pur:hover{{background:rgba(194,84,58,.22)}}
...
.lock-banner{{background:linear-gradient(150deg,rgba(24,155,173,.16),rgba(24,155,173,.02) 70%);padding:38px 30px 26px;position:relative}}
...
[data-theme="light"] .lock-inp{{background:rgba(15,124,140,.04)}}
...
.toast.show{{opacity:1;transform:translateX(-50%) translateY(0)}}
.toast.ok{{border-color:rgba(33,179,156,.35);background:var(--green-bg);color:var(--green-t)}}
...
body{{font-size:15px}}
.brand-name{{font-size:17px;font-weight:800;letter-spacing:-.01em}}
.brand-sub{{font-size:12px;margin-top:3px}}
.btn{{border-radius:12px;font-weight:600}}
.btn:hover{{transform:translateY(-1px)}}
.btn:active{{transform:translateY(0)}}
.footer{{font-size:12.5px;line-height:1.9;display:flex;align-items:center;justify-content:center;gap:7px}}
.qr-box{{border-radius:20px}}
.qr-title{{font-size:15px;font-weight:700}}
</style>
</head>
<body>
...
<div class="wrap">
  <div class="top">
    <div class="brand">
      <div><div class="brand-name">پنل اشتراک</div><div class="brand-sub">کانفیگ‌های شما</div></div>
    </div>
  ...
  <div class="footer"><i class="ti ti-shield-check"></i> این صفحه فقط برای شما ساخته شده است</div>
</div>
<script>
